...
class TestMakeKey:
    ...
    def test_argument_order_irrelevant(self) -> None:
    ...
    def test_different_data_types_different_keys(self) -> None:
        k1 = make_key("price_history", symbol="AAPL")
        k2 = make_key("quote", symbol="AAPL")
        assert k1 != k2

    def test_date_and_string_produce_same_key(self) -> None:
    ...
    def test_provider_not_in_key(self) -> None:
