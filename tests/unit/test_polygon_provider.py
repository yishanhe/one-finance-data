"""Unit tests for PolygonProvider with mocked httpx responses."""
...
def provider() -> PolygonProvider:
    return PolygonProvider(api_key="test_key", timeout=5)
...
class TestConstructor:
    def test_api_key_from_param(self) -> None:
        p = PolygonProvider(api_key="my_key")
    ...
    def test_name(self) -> None:
        assert PolygonProvider(api_key="k").name == "polygon"
...
class TestRateLimitDetection:
    def test_http_429_raises(self, provider: PolygonProvider) -> None:
    ...
    def test_is_rate_limited_429(self, provider: PolygonProvider) -> None:
        resp = _mock_response({}, 429)
        assert provider.is_rate_limited(resp) is True

    def test_is_rate_limited_200_returns_false(self, provider: PolygonProvider) -> None:
        resp = _mock_response({"status": "OK"})
        assert provider.is_rate_limited(resp) is False

    def test_is_rate_limited_exception_with_429(self, provider: PolygonProvider) -> None:
        assert provider.is_rate_limited(Exception("HTTP 429 Too Many Requests")) is True

    def test_is_rate_limited_exception_no_match(self, provider: PolygonProvider) -> None:
        assert provider.is_rate_limited(Exception("connection timeout")) is False

    def test_is_rate_limited_non_httpx_returns_false(self, provider: PolygonProvider) -> None:
        assert provider.is_rate_limited("some string") is False

    def test_cooldown_returns_default(self, provider: PolygonProvider) -> None:
        resp = _mock_response({}, 429)
...
class TestGetMethod:
    ...
    def test_non_retryable_error(self, provider: PolygonProvider) -> None:
...
class TestGetPriceHistory:
    def test_returns_bars(self, provider: PolygonProvider) -> None:
    ...
    def test_fields_correct(self, provider: PolygonProvider) -> None:
        with patch.object(provider._client, "get", return_value=_mock_response(_PRICE_PAYLOAD)):
            bars = provider.get_price_history("AAPL", date(2024, 1, 1), date(2024, 1, 31))
        b = bars[0]
    ...
    def test_empty_results_returns_empty(self, provider: PolygonProvider) -> None:
        with patch.object(provider._client, "get", return_value=_mock_response({"status": "OK"})):
            bars = provider.get_price_history("AAPL", date(2024, 1, 1), date(2024, 1, 31))
        assert bars == []

    def test_unsupported_interval_raises(self, provider: PolygonProvider) -> None:
        with pytest.raises(ProviderError):
            provider.get_price_history("AAPL", date(2024, 1, 1), date(2024, 1, 31), interval="4h")

    def test_intraday_has_timestamp(self, provider: PolygonProvider) -> None:
        payload = {
            "results": [
    ...
    def test_malformed_bar_is_skipped(self, provider: PolygonProvider) -> None:
        payload = {
            "results": [
...
class TestGetQuote:
    def test_returns_quote(self, provider: PolygonProvider) -> None:
    ...
    def test_no_ticker_raises(self, provider: PolygonProvider) -> None:
        with patch.object(provider._client, "get", return_value=_mock_response({"status": "OK"})):
            with pytest.raises(ProviderError):
                provider.get_quote("AAPL")

    def test_no_price_raises(self, provider: PolygonProvider) -> None:
        payload = {
            "status": "OK",
            "ticker": {
                "ticker": "AAPL",
    ...
    def test_fallback_to_day_close_when_no_last_trade(self, provider: PolygonProvider) -> None:
        payload = {
            "status": "OK",
            "ticker": {
                "ticker": "AAPL",
    ...
    def test_timestamp_from_updated_when_no_trade_ts(self, provider: PolygonProvider) -> None:
        payload = {
            "status": "OK",
            "ticker": {
                "ticker": "AAPL",
    ...
    def test_timestamp_fallback_to_now_when_no_updated(self, provider: PolygonProvider) -> None:
        payload = {
            "status": "OK",
            "ticker": {
                "ticker": "AAPL",
    ...
    def test_bad_trade_timestamp_falls_back_to_now(self, provider: PolygonProvider) -> None:
    ...
    def test_bad_updated_timestamp_falls_back_to_now(self, provider: PolygonProvider) -> None:
        payload = {
            "status": "OK",
            "ticker": {
                "ticker": "AAPL",
...
class TestGetInfo:
    def test_returns_company_info(self, provider: PolygonProvider) -> None:
    ...
    def test_fields_correct(self, provider: PolygonProvider) -> None:
        ...
        assert info.sector is None  # Polygon doesn't classify by sector
    ...
    def test_no_results_raises(self, provider: PolygonProvider) -> None:
        with patch.object(provider._client, "get", return_value=_mock_response({"status": "OK"})):
            with pytest.raises(ProviderError):
                provider.get_info("AAPL")

    def test_non_dict_results_raises(self, provider: PolygonProvider) -> None:
        with patch.object(
            provider._client,
            "get",
    ...
    def test_short_currency_name_sets_none(self, provider: PolygonProvider) -> None:
    ...
    def test_empty_locale_sets_none_country(self, provider: PolygonProvider) -> None:
        payload = dict(_INFO_PAYLOAD)
        payload["results"] = dict(_INFO_PAYLOAD["results"])  # type: ignore[arg-type]
...
class TestGetNews:
    def test_returns_articles(self, provider: PolygonProvider) -> None:
    ...
    def test_skips_article_with_no_title(self, provider: PolygonProvider) -> None:
        payload = {
            "results": [
                {
                    "publisher": {"name": "X"},
    ...
    def test_skips_article_with_no_url(self, provider: PolygonProvider) -> None:
        payload = {
            "results": [
                {
                    "publisher": {"name": "X"},
    ...
    def test_bad_timestamp_falls_back_to_now(self, provider: PolygonProvider) -> None:
        payload = {
            "results": [
                {
                    "publisher": {"name": "X"},
    ...
    def test_missing_publisher_uses_unknown(self, provider: PolygonProvider) -> None:
        payload = {
            "results": [
                {
                    "publisher": {},
    ...
    def test_malformed_item_is_skipped(self, provider: PolygonProvider) -> None:
...
class TestGetCorporateActions:
    def test_returns_dividends_and_splits(self, provider: PolygonProvider) -> None:
    ...
    def test_dividend_fields(self, provider: PolygonProvider) -> None:
        ...
        assert div.source == "polygon"

    def test_split_ratio_correct(self, provider: PolygonProvider) -> None:
    ...
    def test_sorted_descending(self, provider: PolygonProvider) -> None:
        div_payload = {
            "results": [
    ...
    def test_skips_dividend_with_no_date(self, provider: PolygonProvider) -> None:
        payload = {
            "results": [
    ...
    def test_skips_split_with_no_date(self, provider: PolygonProvider) -> None:
        payload = {
            "results": [
    ...
    def test_malformed_dividend_is_skipped(self, provider: PolygonProvider) -> None:
    ...
    def test_malformed_split_is_skipped(self, provider: PolygonProvider) -> None:
        payload = {
            "results": [
